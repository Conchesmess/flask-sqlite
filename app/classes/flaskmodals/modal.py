...
from flask import (Blueprint, render_template, get_flashed_messages,request)
...
def response(template=None):
    '''Use this decorator if coding `render_template_mctx = current_app._get_current_object() odal` in a number
